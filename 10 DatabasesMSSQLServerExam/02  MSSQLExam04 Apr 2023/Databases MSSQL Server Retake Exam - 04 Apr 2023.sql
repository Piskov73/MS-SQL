 ...
 --01. DDL
	...
	INSERT INTO Invoices(Number,IssueDate,DueDate,Amount,Currency,ClientId)
		...
		/*Тази заявка селектира колоната Id от таблицата Addresses,
		където адресът съвпада с конкретно зададените стойности

		This query selects the Id column from the Addresses 
		table where the address matches the specified values.*/
